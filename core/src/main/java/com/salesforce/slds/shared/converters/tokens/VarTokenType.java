...
import static com.salesforce.slds.shared.RegexPattern.VAR_FUNCTION;

public class VarTokenType implements Type {

    private static final Pattern pattern = Pattern.compile(VAR_FUNCTION, Pattern.CASE_INSENSITIVE);
